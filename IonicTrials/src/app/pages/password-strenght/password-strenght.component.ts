...
export class PasswordStrenghtComponent implements OnChanges {
  ...
  ngOnChanges(changes: { [propName: string]: SimpleChange }): void {
    ...
    if (password) {
      const c = this.getColor(PasswordStrenghtComponent.checkStrength(password));
      this.setBarColors(c.idx, c.col);

      const pwdStrength = PasswordStrenghtComponent.checkStrength(password);
